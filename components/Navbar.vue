<template>
  <nav class="fadeIn mx-auto pb-12">
      ...
      <a class="nav-link-gitlab" rel="noopener" target="_blank" href="https://gitlab.com/sleeppyy/portfolio">source code</a>
  </nav>
</template>

<style>
  .nav-link {
    @apply lowercase text-gray-600 text-base mx-2 transition-all
  }
  .nav-link:hover {
    @apply text-white
  }
