...
let errors = {
  ...
  invalidlet: "invalid left-hand side of assignment near '%1'"
}
...
function raise(token) {
  let message = sprintf.apply(null, slice.call(arguments, 1)),
    error, col
...
function lex() {
  ...
  switch (charCode) {
    ...
    case 46: // .
      ...
      if (46 === next) {
        if (46 === input.charCodeAt(index + 2)) return scanletargLiteral()
    ...
    case 124: // ||
      if (124 === next) return scanPunctuator("||")
      return scanPunctuator("|")
...
// A letarg literal consists of three dots.

function scanletargLiteral() {
  index += 3
  return {
    type: "letargLiteral",
    value: "...",
...
function scanNumericLiteral() {
  ...
  let value = ("0" === character && "xX".indexOf(next || null) >= 0) ?
...
function isKeyword(id) {
  switch (id.length) {
    ...
    case 6:
      return "elseif" === id || "repeat" === id || "return" === id || "static" === id || "public" == id
    case 7:
      return "extends" === id
    case 8:
